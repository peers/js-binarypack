...
function _onReaderLoad(){
  var cb = this.obj.callbacks.pop();
  cb.apply(this.obj,[this.result]);
}

// Float

function _float32unpack(number){
  this.callbacks.pop()((new Float32Array(number))[0]);
}

function _float64unpack(number){
  this.callbacks.pop()((new Float64Array(number))[0]);
}

// Unsigned int

function _uint8unpack(number){
  this.callbacks.pop()((new Uint8Array(number))[0]);
}

function _uint16unpack(number){
  this.callbacks.pop()((new Uint16Array(number))[0]);
}

function _uint32unpack(number){
  this.callbacks.pop()((new Uint32Array(number))[0]);
}

// Int

function _int8unpack(number){
  this.callbacks.pop()((new Int8Array(number))[0]);
}

function _int16unpack(number){
  this.callbacks.pop()((new Int16Array(number))[0]);
}

function _int32unpack(number){
  this.callbacks.pop()((new Int32Array(number))[0]);
}

// String

function _startStringUnpack(byte){
  byte = (new Uint8Array(number))[0];
  
  if(byte == 0xff){
    var string = this.stringBuffer;
    this.stringBuffer = '';
    this.codeBuffer = 0;
    return this.callbacks.pop()(string);
  }
...
function _dateUnpack(number){
  ...
  this.callbacks.pop()(new Date(number));
}
...
function _getFileSize(size){
  ...
  if(FileConstructor) this.callbacks.pop()(new File([blob],name,{type: type,lastModified: date}));
  else{
    blob.name = name;
    blob.lastModifiedDate = new Date(date);
    this.callbacks.pop()(blob);
  }
}
...
function _getUint8ArrayBuffer(buffer){
  ...
  this.callbacks.pop()(new Uint8Array(buffer,byteOffset,byteLength));
}
...
function _getUint16ArrayBuffer(buffer){
  ...
  this.callbacks.pop()(new Uint16Array(buffer,byteOffset,byteLength/2));
}
...
function _getUint32ArrayBuffer(buffer){
  ...
  this.callbacks.pop()(new Uint32Array(buffer,byteOffset,byteLength/4));
}
...
function _getInt8ArrayBuffer(buffer){
  ...
  this.callbacks.pop()(new Int8Array(buffer,byteOffset,byteLength));
}
...
function _getInt16ArrayBuffer(buffer){
  ...
  this.callbacks.pop()(new Int16Array(buffer,byteOffset,byteLength/2));
}
...
function _getInt32ArrayBuffer(buffer){
  ...
  this.callbacks.pop()(new Int32Array(buffer,byteOffset,byteLength/4));
}
...
function _getFloat32ArrayBuffer(buffer){
  ...
  this.callbacks.pop()(new Float32Array(buffer,byteOffset,byteLength/4));
}
...
function _getFloat64ArrayBuffer(buffer){
  ...
  this.callbacks.pop()(new Float64Array(buffer,byteOffset,byteLength/8));
}
...
function _rawUnpack(type){
  ...
  // Very short integers
  if(type >= 0xf0) return this.callbacks.pop()(type & 0x0f);
  if(type >= 0xe0) return this.callbacks.pop()(-(type & 0x0f + 1));
  
  switch(type){
    
    // null / undefined
    case 0x00:
      return this.callbacks.pop()(null);
    case 0x01:
      return this.callbacks.pop()(undefined);
      
    // Boolean
    case 0x02:
      return this.callbacks.pop()(false);
    case 0x03:
      return this.callbacks.pop()(true);
...
Unpacker.prototype.unpack = function(){
  ...
  // Very short integers
  if(type >= 0xf0) return type & 0x0f;
  if(type >= 0xe0) return -(type & 0x0f + 1);
