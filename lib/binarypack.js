...
function _getObjectNextElement(element){
  ...
  if(--this.sizeBuffer[this.sizeBuffer.length - 1] == 0){
    this.sizeBuffer.pop();
    this.callbacks.pop().call(this,this.backReferences.pop());
  }else this.unpack(_getObjectNextElement);
}
...
function _rawUnpack(type){
  ...
  // Very short integers
  if(type >= 0xf0) return this.callbacks.pop().call(this,type & 0x0f);
  if(type >= 0xe0) return this.callbacks.pop().call(this,-(type & 0x0f + 1));
